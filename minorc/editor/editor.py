...
sys.path.append('C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\')
sys.path.append('C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\augus')
import syntax_pars
...
class Main(QtWidgets.QMainWindow):
    ...
    def initToolbar(self):
        ...
        self.ejecutar= QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\run.png"),"Ejecutar",self)
        ...
        self.descendente= QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\run.png"),"Ejecutar Descendente",self)
        ...
        self.debugear= QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\debug.png"),"Debugear",self)
        ...
        self.debugear2= QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\debug.png"),"Debugear",self)
        self.debugear2.setShortcut("Ctrl+E")
        self.debugear2.setStatusTip("Compila los contenidos paso a paso")
        self.debugear2.triggered.connect(self.debug2)

        self.newAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\new.png"),"New",self)
        self.newAction.setShortcut("Ctrl+N")
        self.newAction.setStatusTip("Create a new document from scratch.")
        self.newAction.triggered.connect(self.new)

        self.openAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\open.png"),"Open file",self)
        self.openAction.setStatusTip("Open existing document")
        self.openAction.setShortcut("Ctrl+O")
        self.openAction.triggered.connect(self.open)

        self.saveAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\save.png"),"Save",self)
        self.saveAction.setStatusTip("Save document")
        self.saveAction.setShortcut("Ctrl+S")
        self.saveAction.triggered.connect(self.save)

        self.printAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\print.png"),"Print document",self)
        self.printAction.setStatusTip("Print document")
        self.printAction.setShortcut("Ctrl+P")
        self.printAction.triggered.connect(self.printHandler)

        self.previewAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\preview.png"),"Page view",self)
        self.previewAction.setStatusTip("Preview page before printing")
        self.previewAction.setShortcut("Ctrl+Shift+P")
        self.previewAction.triggered.connect(self.preview)

        self.findAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\find.png"),"Find and replace",self)
        self.findAction.setStatusTip("Find and replace words in your document")
        self.findAction.setShortcut("Ctrl+F")
        self.findAction.triggered.connect(find.Find(self).show)

        self.cutAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\cut.png"),"Cut to clipboard",self)
        self.cutAction.setStatusTip("Delete and copy text to clipboard")
        self.cutAction.setShortcut("Ctrl+X")
        self.cutAction.triggered.connect(self.text.cut)

        self.copyAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\copy.png"),"Copy to clipboard",self)
        self.copyAction.setStatusTip("Copy text to clipboard")
        self.copyAction.setShortcut("Ctrl+C")
        self.copyAction.triggered.connect(self.text.copy)

        self.pasteAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\paste.png"),"Paste from clipboard",self)
        self.pasteAction.setStatusTip("Paste text from clipboard")
        self.pasteAction.setShortcut("Ctrl+V")
        self.pasteAction.triggered.connect(self.text.paste)

        self.undoAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\undo.png"),"Undo last action",self)
        self.undoAction.setStatusTip("Undo last action")
        self.undoAction.setShortcut("Ctrl+Z")
        self.undoAction.triggered.connect(self.text.undo)

        self.redoAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\redo.png"),"Redo last undone thing",self)
        self.redoAction.setStatusTip("Redo last undone thing")
        self.redoAction.setShortcut("Ctrl+Y")
        self.redoAction.triggered.connect(self.text.redo)

        dateTimeAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\calender.png"),"Insert current date/time",self)
        dateTimeAction.setStatusTip("Insert current date/time")
        dateTimeAction.setShortcut("Ctrl+D")
        dateTimeAction.triggered.connect(datetime.DateTime(self).show)

        wordCountAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\count.png"),"See word/symbol count",self)
        wordCountAction.setStatusTip("See word/symbol count")
        wordCountAction.setShortcut("Ctrl+W")
        wordCountAction.triggered.connect(self.wordCount)

        tableAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\table.png"),"Insert table",self)
        tableAction.setStatusTip("Insert table")
        tableAction.setShortcut("Ctrl+T")
        tableAction.triggered.connect(table.Table(self).show)

        imageAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\image.png"),"Insert image",self)
        imageAction.setStatusTip("Insert image")
        imageAction.setShortcut("Ctrl+Shift+I")
        imageAction.triggered.connect(self.insertImage)

        bulletAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\bullet.png"),"Insert bullet List",self)
        bulletAction.setStatusTip("Insert bullet list")
        bulletAction.setShortcut("Ctrl+Shift+B")
        bulletAction.triggered.connect(self.bulletList)

        numberedAction = QtWidgets.QAction(QtGui.QIcon("C:\\Users\\EEGSA\\Documents\\proyecto2\\minorc\\editor\\iconos\\number.png"),"Insert numbered List",self)
        ...
        self.toolbar.addAction(self.debugear2)
    ...
    def initMenubar(self):
        ...
        debug2.addAction(self.debugear2)
    ...
    def initUI(self):
        ...
        self.text3 = QtWidgets.QTextEdit(self)
        ...
        highlight2 = syntax_pars.PythonHighlighter(self.text3)
        ...
        self.text.setGeometry(0,55,1000,200)
        self.text3.setGeometry(0,255,1000,200)
        self.text2.setGeometry(0,455,1000,200)
        self.setGeometry(100,100,1000,700)
        
        self.setWindowTitle("MinorC")
    ...
    def debug2(self):
        ...
        p2.graficar_arbol(instrucciones)
        p2.procesar_instrucciones_main_debug(instrucciones,contador, ts_global)
        contador += 1
        cadena = p2.getCadena()
